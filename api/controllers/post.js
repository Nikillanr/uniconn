...
export const getPosts = (req,res)=>{
    ...
    jwt.verify(token, "secretkey", (err, userInfo)=>{
        ...
        const q = 'SELECT p.*, u.id as userid, name, profilePic FROM posts as p JOIN users as u ON (u.id = p.userid) LEFT JOIN relationships as r ON (p.userid = r.followedUserId) WHERE r.folowerUserId = ? OR p.userId = ? ORDER BY p.createdAt DESC';
